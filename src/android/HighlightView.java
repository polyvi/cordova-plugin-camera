...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = XResourceManager.getInstance()
                .getCameraCropWidthResource(resources);
        mResizeDrawableHeight = XResourceManager.getInstance()
                .getCameraCropHeightResource(resources);
        mResizeDrawableDiagonal = XResourceManager.getInstance()
                .getCameraCropIndicatorResource(resources);
    }
